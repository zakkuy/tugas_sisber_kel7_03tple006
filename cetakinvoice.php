...
$formattedTokens = chunk_split($formattedToken, 4, ' ');
...
<body>
  <div class="container">
    <div class="header">
      ...
      <div class="close-icon"><a href="pembeliantoken.php" style="text-decoration: none; color: black;">×</a></div>
    </div>
    <div class="info">
    <div class="left">
    ...
    <div class="token" style="font-size: 24px; font-weight: bold;">
      <p><span class="bold"><span class="center-text"><?php echo htmlspecialchars($formattedTokens); ?></span></p>
    </div>
